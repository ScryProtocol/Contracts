...
- Hub flow automatically:
  ...
  2. Picks a compatible offer by route/network/asset.
  3. Checks agent state for `hub:<hubEndpoint>` channel.
  4. Computes top-up target using offer amount + hub fee policy.
  5. Checks wallet balance and ERC20 allowance.
  6. Opens or funds channel when needed.
  7. Submits paid request using existing SCP signing flow.
